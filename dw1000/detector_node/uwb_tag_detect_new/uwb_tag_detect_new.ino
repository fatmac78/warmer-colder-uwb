...
// leds pins
const uint8_t PIN_WARM1 = 26; // warmer level 1 LED pin
const uint8_t PIN_WARM2 = 33; // warmer level 2 LED pin
const uint8_t PIN_WARM3 = 15; // warmer level 3 LED pin
...
const uint8_t PIN_DETECT = 14; // hidden node detected LED    
const uint8_t PIN_NEAR1 = 22; // warmer level 1 LED pin  works great
const uint8_t PIN_NEAR2 = 21; // warmer level 1 LED pin   works great
const uint8_t PIN_NEAR3 = 5; // warmer level 1 LED pin   works great
const uint8_t PIN_NEAR4 = 3; // warmer level 1 LED pin   works great
const uint8_t PIN_NEAR5 = 14; // warmer level 1 LED pin   works great
...
void newRange()
{
    ...
    digitalWrite(PIN_NEAR5, HIGH); // turn the LED on
